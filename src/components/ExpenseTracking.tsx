  ...
  return (
    <div className="bg-gray-50 px-4 py-5 rounded-3xl">
      <div className="flex justify-between items-center mb-2">
        ...
        >
          {sortDesc ? <ChartBarDecreasing /> : <ChartBarIncreasing />}
        </button>
      ...
      <div className="mt-3 space-y-2">
        {expenses.map((expense) => (
          <div key={expense.id} className="flex items-center justify-between bg-white p-3 rounded-xl">
            <div className="flex items-center">
              <div className="w-8 h-8 rounded-full flex items-center justify-center bg-gray-100">{expense.icon}</div>
